  ...
  var keyData = {
          q: {sound: new Howl({src: ['sounds/bubbles.mp3']}),color: '#1abc9c', onplayerror: function(){
          	sound.once('unlock', function(){sound.play();})
          }},
  ...
  $('.key').click(function(){
  	...
  	if(keyData[keyId]){
          ...
          newCircle.fillColor = keyData[keyId].color;
          keyData[keyId].sound.play();
  	...
  	setTimeout(function(){
  	    $this.css({color: 'white', background: 'transparent'}); 	
  	},100);
  })